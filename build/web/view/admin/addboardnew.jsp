                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/new/add" method="post" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-2" placeholder="Tên tin tức" pattern="^.{1,}$" name="new-title" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="input-18" placeholder="Địa chỉ hình ảnh" name="new-image_link" required>
                            </div>
                            <div class="form-group">
