                                                ...
                                                <div id="collapseFour">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="email" placeholder="Email*" required="required" name="transaction_email" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" 
                                                                    title="Sai định dạng email" value="${user.email}">
                                                                </div>                             
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="tel" placeholder="Số điện thoại*" required="required" name="transaction_phone" pattern="^\d{10}$" title="Số điện thoại chỉ bao gồm 10 số" value="${user.phone}">
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="aa-checkout-single-bill">
                                                                    <input type="date" placeholder="createDate" name="transaction_created" id="the-date" style="display: none">             
                                                                </div>                             
                                                            </div>                            
                                                        </div>             
