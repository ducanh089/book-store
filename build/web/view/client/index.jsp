                        ...
                        <div class="col-md-5 no-padding">                
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">                    
                                    <img src="${url}/images/promo_slide_2.jpg" alt="img">                    
                                </div>
                            </div>
                        </div>
                        <!-- promo right -->
                        <div class="col-md-7 no-padding">
                            <div class="aa-promo-right">
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/section6.jpg" alt="img">                      
                                ...
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/section7.png" alt="img">                      
                                        <div class="aa-prom-content">
                                ...
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/section8.png" alt="img">                      
                                        <div class="aa-prom-content">
                                ...
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/section9.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#truyentranh" data-toggle="tab">truyện tranh</a></li>
                                <li><a href="#tieuthuyet" data-toggle="tab">tiểu thuyết</a></li>
                                <li><a href="#giatuong" data-toggle="tab">giả tưởng</a></li>
                                <li><a href="#trinhtham" data-toggle="tab">trinh thám</a></li>
                                <li><a href="#ngontinh" data-toggle="tab">ngôn tình</a></li>
                                <li><a href="#kinhdien" data-toggle="tab">kinh điển</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                <!-- Start men product category -->
                                <div class="tab-pane fade in active" id="truyentranh">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${truyentranh}" var="product" end="7">
                                            <li>
                                ...
                                <div class="tab-pane fade" id="tieuthuyet">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${tieuthuyet}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                ...
                                <div class="tab-pane fade" id="giatuong">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${giatuong}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
                                ...
                                <div class="tab-pane fade" id="trinhtham">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${trinhtham}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
                                ...
                                <div class="tab-pane fade" id="ngontinh">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${ngontinh}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
                                ...
                                <div class="tab-pane fade" id="kinhdien">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${kinhdien}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
                ...
                <div class="aa-support-area">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <P>Chúng tôi hiện tại áp dụng miễn phí cho mọi đơn hàng mua trên website.</P>
                        </div>
                    </div>
                    <!-- single support -->
                    <div class="col-md-4 col-sm-4 col-xs-12">
