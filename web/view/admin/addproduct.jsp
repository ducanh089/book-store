                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/product/add" method="POST" enctype='multipart/form-data'>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" placeholder="Tên sản phẩm" pattern="^.{1,}$" name="product-name" required>
                            </div>
                            <div class="form-group">
                                <label for="input-1">Ảnh đại diện</label>
                                <input type="file" id="input-1" name="product-image" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" placeholder="Giá" pattern="^\d{2,3}(\.\d{3}){1,}$" title="Giá có định dạng '.000'" name="product-price" required>
                            </div>
                            <div class="form-group">
                                <label for="input-2">Giảm giá</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Giảm ... %" pattern="^\d{1,3}$" name="product-discount" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" placeholder="Sản phẩm" pattern="^\d{1,}$" name="product-sum" required>
                            </div>
                            <div class="form-group">
