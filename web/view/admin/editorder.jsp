                            ...
                            <c:choose>
                                <c:when test="${order.status == 'Đã hủy'}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly="readonly" id="input-1" name="order-mail" pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" 
                                               title="Sai định dạng email" value="${order.user_mail}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="input-1">Số điện thoại</label>
                                        <input type="text" class="form-control" readonly="readonly" id="input-1" name="order-phone" pattern="^\d{10}$" title="Số điện thoại chỉ bao gồm 10 số" value="${order.user_phone}" required>
                                    </div>
